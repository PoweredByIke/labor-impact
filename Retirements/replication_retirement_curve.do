...
forvalues t = 0/9{
	replace retirement_2030 = retirement_rate`=`t' + 61' if age == `=`t' + 49'
}
...
gen share_retired = number_retired_/number_here
keep year share_retired
save "./intermediate/share_retired.dta", replace

use future_miles, clear
keep if year == 2017
local 2017_jobs = total_miles4[1]/89801

use "./intermediate/share_retired.dta", clear
gen total_retired = `2017_jobs'*share_retired

save retirements.dta, replace
